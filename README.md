...
- **LKPD & Refleksi**: jawaban siswa tersimpan otomatis di browser masing-masing perangkat (localStorage), bukan di server bersama. Sebelum mengerjakan, siswa mengisi **Nama, Kelas, dan Nomor Absen** di bagian atas LKPD. LKPD 1 dan LKPD 2 masing-masing punya tombol sendiri, **"Cetak / Simpan sebagai PDF (LKPD 1)"** dan **"... (LKPD 2)"** — setiap tombol hanya mencetak lembar jawaban LKPD tersebut (identitas siswa + jawaban tiap langkah, tanpa kotak input dan tanpa materi/kalkulator/latihan soal di sekitarnya), siap dikirim ke guru sebagai PDF.
